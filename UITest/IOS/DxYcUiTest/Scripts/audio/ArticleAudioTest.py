...
class ArticleAudioTest(unittest.TestCase):
    ...
    def testDestroy(self):
        ...
        self.result = self.common_check(NORMAL_AUDIO_ARTICLE)

    def testPlayerLocation(self):
        self.case_id = get_case(__file__)
        self.result = self.location_check(NORMAL_AUDIO_ARTICLE)

    def testBack(self):
        self.case_id = get_case(__file__)
        self.result = self.back_check(NORMAL_AUDIO_ARTICLE)

    def testPauseBack(self):
        self.case_id = get_case(__file__)
        self.result = self.destroy_check(NORMAL_AUDIO_ARTICLE)
