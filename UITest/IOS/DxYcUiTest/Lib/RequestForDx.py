...
class RequestForDx(object):
    ...
    def __init__(self,ec='420000000010000',cc='420100',p='a',v='3.1.2',ak=str(AK),dc = "1,0,0,93JhERG1UYLiW.p6UfdubuLUFveUZCjg6v.QMEkHKu8=#cc36a2ebfc32b210b90f91f8885de0bc",tid='a_imei865479020303095',pid = '100d855909470b42cd9',loc = 'abc',chnl_para='cnhubei',secret ="dJEeE#dIRq"):
        self.secret = secret
