...
class MyCommentBasicTest(unittest.TestCase):
    ...
    def common_check(self,content,quote_content):
        ...
        first_digg_count = self.driver.find_element_by_id(DIGG_COUNT).text
        ...
        first_digg_count = self.driver.find_elements_by_id(DIGG_COUNT)[2].text
        assert first_digg_count == '1'
        ...
        first_digg_count = self.driver.find_elements_by_id(DIGG_COUNT)[0].text
        assert first_digg_count == '1'
