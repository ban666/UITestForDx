...
class CommentBasicTest(unittest.TestCase):
    ...
    def common_check(self,driver):
        ...
        reply_comment = driver.find_element_by_id('com.zc.hubei_news:id/rl_comment')
        ...
        first_digg_count = driver.find_elements_by_id('com.zc.hubei_news:id/tv_digg')[2].text
        assert first_digg_count == '1'
        ...
        first_digg_count = driver.find_elements_by_id('com.zc.hubei_news:id/tv_digg')[0].text
        assert first_digg_count == '1'
