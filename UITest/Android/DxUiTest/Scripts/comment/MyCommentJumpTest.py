...
class MyCommentJumpTest(unittest.TestCase):
    ...
    def common_check(self,activity):
        ...
        print self.driver.current_activity,activity
        assert self.driver.current_activity == activity
        print u'Step %s:我的评论-回复我的跳转测试：OK' % (str(step))
        step+=1
    ...
    def testMyCommentClue(self):
        article = 'head'
        info_str = u'报料'
        clue_id = self.db.get_first_clue(2)
