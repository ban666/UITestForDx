...
class TestLogin(object):
    ...
    '''
    我的评论：com.zc.hubei_news:id/ll_mycomment
    我的收藏：com.zc.hubei_news:id/ll_fav
    我的消息：com.zc.hubei_news:id/ll_mymsg
    我的爆料：com.zc.hubei_news:id/ll_baoliao
    我的邀请：com.zc.hubei_news:id/ll_invitation
    订制版本：com.zc.hubei_news:id/ll_entaccount
    优惠商城：com.zc.hubei_news:id/ll_discount_store
    我的报刊：com.zc.hubei_news:id/ll_mypaper
    设置：com.zc.hubei_news:id/ll_setting
    意见反馈：com.zc.hubei_news:id/ll_reply

    返回键：com.zc.hubei_news:id/btn_top_bar_back
    '''
