...
def check_login_status():
    content = get_config_by_adb(desired_caps['appPackage'])
    if content.get('uid'):
        return True
    return False
...
if __name__ == '__main__':
    ...
    from config import *
    pro =  get_product_name()
    print pro
    print search_postion.keys()
    print search_postion.has_key(pro)