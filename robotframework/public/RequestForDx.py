...
class RequestForDx(object):
    ...
    def __init__(self,ec='420000000010000',cc='420100',p='a',v='3.1.2',ak='1',dc = '1,0,0,suiZBeeEhYc391o8NI6samFpGXp8kd8L0ALLxd7Tt5Q=#af65396ebb49846daf9d98343c34f184',tid='a_imei865479020303095',pid = '100d855909470b42cd9',loc = 'abc',chnl_para='cnhubei',secret="yJfRVvn6u9yCpn"):
        self.secret = secret
        ...
        self.defaultdc = '1,0,0,suiZBeeEhYc391o8NI6samFpGXp8kd8L0ALLxd7Tt5Q=#af65396ebb49846daf9d98343c34f184'
        '''
    ...
    def model_init_old_version(self):
        self.payload = {
        'dc':self._dc,
        'ak':self.ak,
        'v'	:self.v,
    ...
    def gen_payload_old_version(self,*args):
        test_data ={}
        self.path = args[0]
        for arg in args[1:]:
            temp = arg.split('=',1)
        ...
        ret.sort()
        param_string = self.secret+"".join(ret)+self.secret
        self.payload['sign'] = hashlib.md5(param_string.encode('utf-8')).hexdigest()
    ...
    def send_request_for_dx_old_version(self,*args):
        self.model_init_old_version()
        self.gen_payload_old_version(*args)
        req = self.domain+self.path
        print req
        res = requests.post(req,data=self.payload)
        if res.status_code==200:
